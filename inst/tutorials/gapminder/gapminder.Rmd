...
Suppose we are interested in comparing typical life expectancy in the states California, Oregon, Washington with the rest of the country. 
...
life %>%
  group_by(coast) %>%
  summarize( mean = mean(expectancy, na.rm=TRUE), 
             median = median(expectancy, na.rm=TRUE) )
```
...
This is calculated below for the life expectancies in the 39 counties of WA state.
