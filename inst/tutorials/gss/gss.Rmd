...
#don't forget to specify na.rm!
```
```{r email-mean-solution"}
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(ui_after=NULL, ui_before=default_ui(url="https://canvas.uw.edu/courses/1519534/quizzes/1627248") )
```
