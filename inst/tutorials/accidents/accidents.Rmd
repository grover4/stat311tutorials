...
The variable `road`` describes the condition of the road at the scene of the accident.
What are the road conditions for most accidents? Create a frequency table of `road` in decending order of frequency. See hints for help.
